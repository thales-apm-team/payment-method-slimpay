package com.payline.payment.slimpay.test;
...
public class Utils {
    ...
    public static final String CUSTOMER_MAIL = "psc.test+mypins_monextrefund_TBqVTNc@slimpay.com";

    private static final Gson parser = new Gson();

    public static SlimpayPaymentResponse createInitiatedPaySafeResponse() {
        String json = "{" +
                "    'object': 'PAYMENT'," +
    ...
    public static SlimpayPaymentResponse createAuthorizedPaySafeResponse() {
        String json = "{" +
                "    'object': 'PAYMENT'," +
                "    'id': 'pay_9743636706_C4xKjolAPk439xoFnbvhZ9ckUq2aBCT4_EUR'," +
                "    'created': 1534498236365," +
    ...
    public static SlimpayPaymentResponse createSuccessPaySafeResponse() {
        String json = "{" +
                "    'object': 'PAYMENT'," +
                "    'id': 'pay_9743636706_C4xKjolAPk439xoFnbvhZ9ckUq2aBCT4_EUR'," +
                "    'created': 1534498236365," +
    ...
    public static SlimpayPaymentResponse createBadPaySafeResponse() {
        String json = "{" +
    ...
    public static SlimpayPaymentResponse createPaySafeResponse(String json) {
    ...
    public static ContractParametersCheckRequest createContractParametersCheckRequest(String kycLevel, String minAge, String countryRestriction, String authorisation) {
        ...
        accountInfo.put(SlimpayCardConstants.KYCLEVEL_KEY, kycLevel);
        accountInfo.put(SlimpayCardConstants.MINAGE_KEY, minAge);
        accountInfo.put(SlimpayCardConstants.COUNTRYRESTRICTION_KEY, countryRestriction);
        accountInfo.put(SlimpayCardConstants.AUTHORISATIONKEY_KEY, authorisation);
...
//                .withPartnerConfiguration(partnerConfiguration)
    ...
    public static ContractConfiguration createContractConfiguration(String kycLevel, String minAge, String countryRestriction, String authorisation) {
        ...
        contractConfiguration.getContractProperties().put(SlimpayCardConstants.KYCLEVEL_KEY, new ContractProperty(kycLevel));
        contractConfiguration.getContractProperties().put(SlimpayCardConstants.MINAGE_KEY, new ContractProperty(minAge));
        contractConfiguration.getContractProperties().put(SlimpayCardConstants.COUNTRYRESTRICTION_KEY, new ContractProperty(countryRestriction));
        contractConfiguration.getContractProperties().put(SlimpayCardConstants.AUTHORISATIONKEY_KEY, new ContractProperty(authorisation));
    ...
    public static ContractConfiguration createDefaultContractConfiguration() {
        final ContractConfiguration contractConfiguration = new ContractConfiguration("", new HashMap<>());
        contractConfiguration.getContractProperties().put(SlimpayCardConstants.AUTHORISATIONKEY_KEY, new ContractProperty(AUTHORISATION_VAL));
        contractConfiguration.getContractProperties().put(SlimpayCardConstants.MINAGE_KEY, new ContractProperty(""));
        contractConfiguration.getContractProperties().put(SlimpayCardConstants.KYCLEVEL_KEY, new ContractProperty(""));
        contractConfiguration.getContractProperties().put(SlimpayCardConstants.COUNTRYRESTRICTION_KEY, new ContractProperty(""));
