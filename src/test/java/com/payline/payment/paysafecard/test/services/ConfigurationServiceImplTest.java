...
import com.payline.payment.slimpay.services.ConfigurationServiceImpl;
...
public class ConfigurationServiceImplTest {
    ...
    public void checkGood() throws IOException, URISyntaxException {
        when(httpClient.initiate(any(SlimpayPaymentRequest.class), anyBoolean())).thenReturn(Utils.createInitiatedPaySafeResponse());
    ...
    public void checkBad() throws IOException, URISyntaxException {
        when(httpClient.initiate(any(SlimpayPaymentRequest.class), anyBoolean())).thenReturn(Utils.createBadPaySafeResponse());
    ...
    public void checkBadMinAge() throws IOException, URISyntaxException {
        ...
        Assert.assertEquals(1, errors.size());
        Assert.assertTrue(errors.containsKey(SlimpayCardConstants.MINAGE_KEY));
    }
    ...
    public void checkBadCountryRestriction() throws IOException, URISyntaxException {
        ...
        Assert.assertEquals(1, errors.size());
        Assert.assertTrue(errors.containsKey(SlimpayCardConstants.COUNTRYRESTRICTION_KEY));
    }

    @Test
    public void checkException() throws IOException, URISyntaxException {
        when(httpClient.initiate(any(SlimpayPaymentRequest.class), anyBoolean())).thenThrow(IOException.class);
    ...
    public void findErrorInvalidKey() {
        ...
        Assert.assertEquals(1, errors.size());
        Assert.assertTrue(errors.containsKey(SlimpayCardConstants.AUTHORISATIONKEY_KEY));
    }
    ...
    public void findErrorInvalidKycLevel() {
        ...
        Assert.assertEquals(1, errors.size());
        Assert.assertTrue(errors.containsKey(SlimpayCardConstants.KYCLEVEL_KEY));
    }
