package com.payline.payment.slimpay.test.integration;
...
import static com.payline.payment.slimpay.test.Utils.SUCCESS_URL;
...
public class ItRefundTest {
    ...
    private Map<String, ContractProperty> generateParameterContract() {
        ...
        propertyHashMap.put(SlimpayCardConstants.AUTHORISATIONKEY_KEY, new ContractProperty(Utils.AUTHORISATION_VAL));
