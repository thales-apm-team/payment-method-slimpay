...
import com.payline.payment.slimpay.services.PaymentServiceImpl;
...
public class PaymentServiceImplTest {
    ...
    public void paymentRequestWithError10007() throws IOException, URISyntaxException  {
        ...
        when(httpClient.initiate(any(SlimpayPaymentRequest.class), anyBoolean())).thenReturn(Utils.createPaySafeResponse(json));
