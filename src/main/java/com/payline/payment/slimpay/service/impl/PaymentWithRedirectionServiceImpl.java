        ...
        try {
            ...
            switch (state) {
                ...
                case CLOSED_COMPLETED:
                    ...
                    return handlePaymentResponse(paymentResponse,transactionId,additionalData.toString());
...
//ajouter un a handlePaymentStatus
//retourner une paiement response adaptée àau statut du paiement en cours
    /**
     ...
     * @return
     */
    public PaymentResponse handlePaymentResponse(SlimpayResponse slimpayPaymentResponse, String partnerTransactionId,String additionalData) {
            if (SlimpayPaymentResponse.class.equals(slimpayPaymentResponse.getClass())) {
                ...
                else if (executionStatus.equals(PaymentExecutionStatus.REJECTED)){
                    LOGGER.error("Payment rejected");
                    return PaymentResponseFailure.PaymentResponseFailureBuilder
                            .aPaymentResponseFailure()
                            .withErrorCode(truncateError("Payment rejected"))
                            .withFailureCause(FailureCause.REFUSED)
                            .withPartnerTransactionId(partnerTransactionId)
                            .build();
