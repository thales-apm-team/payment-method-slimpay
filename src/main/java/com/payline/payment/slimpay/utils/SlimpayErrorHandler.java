...
public class SlimpayErrorHandler {
    ...
    public static PaymentResponseFailure findError(SlimpayPaymentResponse response) {
        FailureCause cause;
    ...
    public static RefundResponse findRefundError(SlimpayPaymentResponse response, String transactionId) {
        FailureCause cause;
