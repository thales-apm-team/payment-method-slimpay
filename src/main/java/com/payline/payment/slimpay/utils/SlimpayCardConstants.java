...
public class SlimpayCardConstants {
    ...
    public static final String SANDBOX_URL = "apitest.slimpay.com";
    public static final String PRODUCTION_URL = "api.slimpay.com";
